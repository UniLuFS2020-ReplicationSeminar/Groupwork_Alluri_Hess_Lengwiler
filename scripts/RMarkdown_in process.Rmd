...
# load dataset
setwd("/Users/kerimlengwiler/Desktop/R_Files/repo_CE1_1/Groupwork_Alluri_Hess_Lengwiler")
...
In the following, we will present the results of our regression models.
...
The scatterplot above shows that there is almost no relationship between age and trust score. Altough the Linear Regression Model for the relationship between Trust Score and Age is significant. The p-value is less than 0.05 (see Regression Table).
...
This means we can reject our first hypothesis, that people living in the city have a higher trust score than people living in the countryside. For our second and third hypothesis, we can neither confirm nor reject them. The trust score does not differ significantly.
